            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                html.Legend('texto consultores por equipe')
                            ])
                        ]),
                        dbc.Row([
                            dbc.Col([
...
def graph5(month, toggle):
    ...
    fig5.update_layout(main_config, height=100, template=template)
    fig6.update_layout(main_config, height=100, template=template)
